...
extension LoginViewController {
    ...
    private func setupConstraints() {
        ...
        let bottomStackView = UIStackView(arrangedSubviews: [needAnAccountLabel, sighUpButton], axis: .horizontal, spacing: 10)
        sighUpButton.contentHorizontalAlignment = .left
